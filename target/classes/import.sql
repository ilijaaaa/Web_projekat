...
INSERT INTO KNJIGA (naslov, slika, opis, isbn, datum, ocena, brstr, zanr_id, autor_id) VALUES ('To Kill a Mockingbird', 'https://www.example.com/to-kill-a-mockingbird.jpg', 'A classic of American literature', '9780061120084', '1960-07-11', 45.23, 281, 1, 2);
INSERT INTO KNJIGA (naslov, slika, opis, isbn, datum, ocena, brstr, zanr_id, autor_id) VALUES ('Pride and Prejudice', 'https://www.example.com/pride-and-prejudice.jpg', 'A novel of manners in early 19th-century England', '9780141439518', '1813-01-28', 47.97, 432, 1, 2);
INSERT INTO KNJIGA (naslov, slika, opis, isbn, datum, ocena, brstr, zanr_id, autor_id) VALUES ('The Da Vinci Code', 'https://www.example.com/the-da-vinci-code.jpg', 'A thriller novel', '9780307474278', '2003-03-18', 39.76, 481, 4, 4);
INSERT INTO KNJIGA (naslov, slika, opis, isbn, datum, ocena, brstr, zanr_id, autor_id) VALUES ('The Catcher in the Rye', 'https://www.example.com/the-catcher-in-the-rye.jpg', 'A controversial novel', '9780316769488', '1951-07-16', 42.56, 277, 2, 2);
INSERT INTO KNJIGA (naslov, slika, opis, isbn, datum, ocena, brstr, zanr_id, autor_id) VALUES ('Harry Potter and the Philosophers Stone', 'https://www.example.com/harry-potter.jpg', 'The first book in the Harry Potter series', '9780747532743', '1997-06-26', 48.32, 223, 3, 4);

-- popunjavanje tabele polica
INSERT INTO POLICA (naziv, primarno) VALUES ('Want to Read', true);
INSERT INTO POLICA (naziv, primarno) VALUES ('Currently Reading', true);
INSERT INTO POLICA (naziv, primarno) VALUES ('Read', true);
INSERT INTO POLICA (naziv, primarno) VALUES ('Favourites', false);
...
INSERT INTO ZAHTEV_ZA_AKTIVACIJU (mejl, telefon, poruka, datum, status) VALUES ('newauthor@example.com', '555-5555', 'I would like to become an author on the platform', '2022-03-20', 'CEKANJE');